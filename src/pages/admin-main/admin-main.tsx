...
const items: MenuItem[] = [
    getItem('赛事方管理', 'admin-main/organizer-manage', <SettingOutlined />),
];
        ...
        <Layout>
            <Sider trigger={null} collapsible collapsed={collapsed} onCollapse={(value) => setCollapsed(value)}>
                <div style={{ height: '80px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <div style={{ color: '#fff', fontSize: '26px' }}>管理员端</div>
                </div>
                <Menu theme="dark" defaultSelectedKeys={['admin-main/organizer-manage']} mode="inline" items={items} onClick={onClick} />
            </Sider>
